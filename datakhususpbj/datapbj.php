...
// FILTER: Hanya untuk Satker "Bagian Pengadaan Barang Dan Jasa"

require_once '../config/database.php';

// KONSTANTA SATKER
define('SATKER_TARGET', 'Bagian Pengadaan Barang Dan Jasa');
...
try {
    ...
    foreach ($config_efisiensi as $tabel => $conf) {
        try {
            ...
            // Cek kolom Nama_Satker
            $satker_col = null;
            $possible_satker = ['Nama_Satker', 'nama_satker', 'NamaSatker', 'satker'];
            foreach($possible_satker as $s) { 
                if(in_array($s, $cols)) { 
                    $satker_col = $s; 
                    break; 
                } 
            ...
            // Skip jika tidak ada kolom satker
            if (!$satker_col) continue;
            ...
            // TAMBAHKAN FILTER SATKER DI QUERY
            $sql = "SELECT 
    ...
    <div class="card-minimal">
        <div class="header-section">
            ...
            <div class="satker-badge">
                <i class="fas fa-building me-1"></i> <?= htmlspecialchars(SATKER_TARGET) ?>
            </div>
            <div class="stats-row">
                <div class="stat-item">
        ...
        <div class="table-responsive">
            <?php if (empty($data_efisiensi_realisasi)): ?>
                <div class="empty-state">
                    ...
                    <small class="text-muted mt-2">Satker: <?= htmlspecialchars(SATKER_TARGET) ?></small>
                </div>
            <?php else: ?>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="text-end">
                                ...
                                <small class="mt-1" style="color: <?= $is_over ? '#dc2626' : '#059669' ?>;">
                        ...
                        <tr class="total-row">
                            ...
                            <td class="text-end fw-bold text-money" style="color: <?= $total_efisiensi_selisih >= 0 ? '#10b981' : '#ef4444' ?>">
        ...
        <div class="footer-note">
            ...
            Data (Pagu) dan realisasi kontrak/pembelian yang tervalidasi pada bulan
            <strong><?= htmlspecialchars($bulan_dipilih) ?></strong> <?= $tahun_dipilih ?>
            untuk satker <strong><?= htmlspecialchars(SATKER_TARGET) ?></strong>.
        </div>
    </div>
</div>

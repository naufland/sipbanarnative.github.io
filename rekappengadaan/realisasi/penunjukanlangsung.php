            ...
            <div class="summary-cards">
                <div class="summary-card primary">
                    ...
                    <div class="card-content">
                        ...
                        <div class="card-subtitle">Penunjukan Langsung - <?= $namaBulan[$selectedBulan] ?> <?= $selectedTahun ?></div>
                    </div>
                </div>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <?php if (!empty($row['Status_Paket'])): ?>
                                        <span class="badge <?= $row['Status_Paket'] == 'Aktif' ? 'badge-success' : ($row['Status_Paket'] == 'Selesai' ? 'badge-info' : 'badge-danger') ?>">

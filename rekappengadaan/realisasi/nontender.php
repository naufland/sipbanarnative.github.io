...
$apiBaseUrl = "http://sipbanar-phpnative.id/api/realisasi_nontender.php";
...
<style>
    ...
    /* Baris kedua: Metode + Jenis + Pencarian */
...
<div class="container">
    <div class="filter-section">
        <div class="filter-header">
            ...
            <h3>Filter Data Realisasi Non-Tender</h3>
        </div>
    ...
    <div class="summary-section">
        <div class="summary-header">
            <div class="summary-header-left">
                ...
                <h3>Ringkasan Data Realisasi Non-Tender</h3>
            </div>
                ...
                <table>
                    <thead>
                        <tr>
                            ...
                            <th style="width: 130px;"><i class="fas fa-file-contract"></i> Nilai Kontrak</th>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="price" style="font-size: 13px;">
                                        <?= 'Rp ' . number_format($row['Nilai_Kontrak'] ?? 0, 0, ',', '.') ?>
                                    </div>
                                </td>
                                <td>

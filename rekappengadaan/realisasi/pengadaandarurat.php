<?php
// =================================================================
// == FILE DASHBOARD UNTUK REALISASI PENGADAAN DARURAT =============
// =================================================================

// 1. URL API untuk Realisasi Pengadaan Darurat
$apiBaseUrl = "http://sipbanar-phpnative.id/api/realisasi_pengadaandarurat.php";
...
// 8. Set judul halaman
$page_title = "Data Realisasi Pengadaan Darurat - SIP BANAR";
...
<div class="container">
    ...
    <div class="results-section">
        <div class="results-header">
            <div>
                <div class="results-title"><i class="fas fa-table"></i> Hasil Data Realisasi Pengadaan Darurat</div>
        ...
        <?php if (!empty($tableData)) : ?>
                    ...
                    <tbody>
                        <?php foreach ($tableData as $row) : ?>
                            <tr>
                                ...
                                <td><i class="fas fa-building" style="margin-right: 5px; color: #16a085;"></i> <?= htmlspecialchars($row['KLPD'] ?? '-') ?></td>
                                <td><?= htmlspecialchars($row['Nama_Satker'] ?? '-') ?></td>
                                <td style="text-align: center;"><span class="badge badge-teal"><?= htmlspecialchars($row['Metode_pengadaan'] ?? '-') ?></span></td>
            ...
            <div class="table-footer">
                ...
                <div><strong>Total Data:</strong> <?= number_format($totalRecords, 0, ',', '.') ?> paket pengadaan darurat</div>
            </div>
        <?php else : ?>

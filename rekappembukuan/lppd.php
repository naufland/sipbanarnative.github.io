...
<style>
    ...
    @media print {
        ...
        /* Only hide external footer, not form footer */
        body > footer,
        body > .footer,
        #footer,
        .site-footer,
        ...
        <form method="GET" action="">
            <div class="filter-content">
                ...
                <div class="form-group">
                    ...
                    <select name="satuan_kerja" id="selectSatker">
            ...
            <div class="form-header">
                ...
                <div class="form-header-text">
                    ...
                    <div class="address">
                        ...
                        http://www.banjarmासinkota.go.id/
                    </div>
                </div>
            </div>
...
<script>
    ...
    function initializeEventListeners() {
        ...
        const selectSatker = document.getElementById('selectSatker');
        if (selectSatker) {

<?php
// File: includes/RealisasiPengadaanDaruratModel.php
...
class RealisasiPengadaanDaruratModel
{
    ...
    public function getRealisasiPengadaanDaruratData($filters = [], $limit = 50, $offset = 0)
    {
    ...
    {
        $allowedColumns = ['Metode_pengadaan', 'Jenis_Pengadaan', 'KLPD', 'Tahun_Anggaran', 'Sumber_Dana'];

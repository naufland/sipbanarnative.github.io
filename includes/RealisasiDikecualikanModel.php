<?php
// File: includes/RealisasiDikecualikanModel.php

class RealisasiDikecualikanModel
{
    private $conn;
    private $table_name = "realisasi_dikecualikan";
    ...
    private function buildWhereClause($filters)
    {
        ...
        // Filter berdasarkan Nama_Satker (ganti dari KLPD)
    ...
    public function getRealisasiDikecualikanData($filters = [], $limit = 50, $offset = 0)
    {
    ...
    {
        $allowedColumns = ['Metode_pengadaan', 'Jenis_Pengadaan', 'Nama_Satker', 'Sumber_Dana'];
